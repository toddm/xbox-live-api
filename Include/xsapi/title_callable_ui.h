...
public:
    ...
    /// </returns>
    _XSAPIIMP static pplx::task<xbox::services::xbox_live_result<std::vector<string_t>>>
    ...
    /// result.err() contains the error based on what happened in the case of an error.
    /// </returns>
    _XSAPIIMP static xbox::services::xbox_live_result<bool>
    ...
    /// result.err() contains the error based on what happened in the case of an error.
    /// </returns>
    _XSAPIIMP static pplx::task<xbox::services::xbox_live_result<bool>>
